...
const redirectUri = encodeURIComponent('https://api.dropentry.com/dev/auth'); // https://7wgnegmbs3.execute-api.ap-southeast-2.amazonaws.com/dev/auth // http://localhost:5500/auth.html
